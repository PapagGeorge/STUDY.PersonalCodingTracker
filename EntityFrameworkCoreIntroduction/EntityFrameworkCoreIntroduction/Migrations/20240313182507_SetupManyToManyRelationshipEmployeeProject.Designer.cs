...
namespace EntityFrameworkCoreIntroduction.Migrations
{
    ...
    [Migration("20240313182507_SetupManyToManyRelationshipEmployeeProject")]
    partial class SetupManyToManyRelationshipEmployeeProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkCoreIntroduction.Models.EmployeeProject", b =>
                {
                    b.Property<int>("EmployeeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityFrameworkCoreIntroduction.Models.Project", b =>
                {
                    b.Property<int>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityFrameworkCoreIntroduction.Models.EmployeeProject", b =>
                {
                    ...
                    b.HasOne("EntityFrameworkCoreIntroduction.Models.Project", "Project")
                        .WithMany("EmployeeProjects")
