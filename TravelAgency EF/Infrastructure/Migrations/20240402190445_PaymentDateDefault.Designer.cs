...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240402190445_PaymentDateDefault")]
    partial class PaymentDateDefault
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Invoice", b =>
                {
                    ...
                    b.Property<DateTime>("IssuedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 2, 22, 4, 45, 22, DateTimeKind.Local).AddTicks(3665));
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("PaymentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 2, 22, 4, 45, 27, DateTimeKind.Local).AddTicks(4277));
            ...
            modelBuilder.Entity("Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 2, 22, 4, 45, 22, DateTimeKind.Local).AddTicks(2482));
